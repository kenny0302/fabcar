...
exports.queryCar = async function (carNumber) {
    try {
...
exports.getHistoryForCar = async function (carNumber) {
    try {
        ...
        // Evaluate the specified transaction.
        // queryCar transaction - requires 1 argument, ex: ('getHistoryForCar', 'CAR4')
